...
var jugador = function(){
  ...
  this.victoria = function(){
    ...
    this.llave = false;   // JUGADOR NO TIENE LA LLAVE
    escenario[8][3] = 3;  // LLAVE EN POSICIÓN INICIAL 
  ...
  this.logicaObjetos = function(){
    ...
    // SALIMO POR LA PUERTA
    if(objeto == 1){
      if(this.llave == true)
        this.victoria();
      else{
        console.log('No has cogido la llave, no puedes salir!');
      }
    }
